...
import com.zhongpengcheng.spine.io.pojo.timeline.EventTimeline;
import com.zhongpengcheng.spine.io.pojo.timeline.ITimeline;

/**
 * {@link EventTimeline}序列化器
 * @author zhongpengcheng
 * @since 2022-02-18 16:59:47
 **/
public class EventTimelineSerializer implements TimelineSerializer {
    @Override
